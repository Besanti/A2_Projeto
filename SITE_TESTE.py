...
if jogador_encontrado:
    ...
    st.write("Não conseguimos encontrar esse jogador no nossos banco de dados. Tente refletir se o nome", nome_jogador, " realmente corresponde a um de nossos GALÁTICOS!")
